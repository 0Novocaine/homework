from sqlalchemy import Boolean, Column, Date, ForeignKey, Integer, String, Table, UniqueConstraint, func
...
class User(Base):
    ...
    # JWT refresh tokens (especially with a unique `jti` claim) can exceed 255 chars.
